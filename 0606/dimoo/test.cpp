...
vector<int> rotate1(const vector<int>& a,int k){
	vector<int> b;
	b.resize(a.size(),0);
	int n=a.size();
...
void solve(bool SPE){ 
	// vector<int> a({4,1,3,5,0,4,2,3,2,0,0,1,4,0});
	// vector<int> a({0,2,0,3,0});
	// vector<int> a({0,1,0,9,1});
	// vector<int> a({0,3,4,3,1,0,2,0,1,0});
	// vector<int> a({1,4,3,0,0,4,1,2,0,4});
	// vector<int> a({2,1,3,1,0,4,3,0,1,1});
	// vector<int> a({0,2,4,3,2,3,0,2,1,0});
	// vector<int> a({0,2,0,2,0});
	int n=100;

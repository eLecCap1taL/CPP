...
void solve(bool SPE){
    foru(i,1,10){
        ...
        cout<<s<<' '<<i*(i+1)*(2*i+1)/6<<endl;
    } 
    // int B=6;
	// foru(a,1,B){
    //     foru(b,1,B){
    //         foru(c,0,B){
    //             if(__gcd(b,c)!=1)   continue;
    //             foru(d,b,B){
    //                 foru(e,d==b?c:0,B){
    //                 if(__gcd(d,e)!=1)   continue;
    //                     foru(f,d,B){
    //                         foru(g,f==d?e:0,B){
    //                             if(__gcd(f,g)!=1)   continue;
    //                             foru(h,1,10){
    //                                 if(__gcd(a,h)!=1)   continue;
    //                                 bool ok=1;
    //                                 foru(n,1,5){
    //                                     int s=0;
    //                                     foru(i,1,n){
    //                                         s+=i*i;
    //                                     }
    //                                     if(!(s*h==a*(b*n+c)*(d*n+e)*(f*n+g))){
    //                                         ok=0;
    //                                         break;
    //                                     }
    //                                 }
    //                                 if(ok){
    //                                     printf("find %d(%dn+%d)(%dn+%d)(%dn+%d)/%d\n",a,b,c,d,e,f,g,h);
    //                                 }
    //                             }
    //                         }
    //                     }

...
signed main()
{
	...
	#ifndef CPEDITOR
	if(freopen("uprising1.in","r",stdin));
	#ifdef ONLINE_JUDGE
	if(freopen("uprising.in","r",stdin));
	if(freopen("uprising.out","w",stdout));
	#endif
	#endif

	cerr<<"static memory: "<<(&m_begin-&m_end)/1024.0/1024.0<<endl;
